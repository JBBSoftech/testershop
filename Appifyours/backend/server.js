...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/testershop_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6958bc8ee10027abdefd107b',
      shopName: 'testershop',
...
app.listen(PORT, () => {
  console.log(`testershop Backend Server running on port ${PORT}`);
});
